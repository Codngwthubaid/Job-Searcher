...
import { CircleDollarSign, CircleUserRound, Loader, LocationEditIcon, ShoppingBag } from "lucide-react";
...
export default function AppliedJobs() {
    ...
    const isAlreadyApplied = () => {
        const hasApplied = userApplications.some((application: any) => application.jobId._id === jobData?._id)
                        ...
                        <div className="flex flex-col lg:flex-row w-full justify-between items-start gap-6">
                            ...
                            <div className="w-full lg:w-[30%]">
                                ...
                                {isJobs
                                    ...
                                    .filter(job => {
                                        // set applied jobIds
                                        const appliedJobIds = new Set(userApplications.map((application: any) => application.jobId._id));
                                        // return true if job._id is not in appliedJobIds
